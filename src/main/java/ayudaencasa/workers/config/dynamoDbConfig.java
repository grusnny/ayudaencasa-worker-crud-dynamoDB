package ayudaencasa.workers.config;
...
public class dynamoDbConfig {
    ...
    public static final String ACCESS_KEY = "AKIA4ODX3DZJNUCEURUJ" ;
    public static final String SECRET_KEY = "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" ;
    @Bean
